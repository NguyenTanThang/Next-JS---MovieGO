...
export const getStaticProps = async () => {
    ...
    return {
      props: { masterImages: images }
    }
  }

function Images({masterImages}) {
    ...
    useEffect(() => {
        (async () => {
            let currentImageData = masterImages;
    ...
    return (
        <div className='image-page'>
            ...
            <Pagination pageObject={pageObject} onChangePageNumber={changePageNumber} pageSizeDefault={6}/>
            <div style={{marginBottom: "20px"}}></div>
            <div className="container-fluid">
